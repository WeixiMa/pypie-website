(() => {
    ...
    render({
        ...
        dialog: [
            message(
                "W",
                "This tutorial shows how to write machine learning code in a productive and enjoyable way, " +
                "through the journey of building three models: a linear regression, a CNN, and an RNN.\n\n" +
