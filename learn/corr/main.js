(() => {
    ...
    render({
        id: "prelude",
        dialog: [
            message("D", "Our next model handles images. We will use it on the Fashion-MNIST dataset. " +
                "It has 70,000 pictures, each picture containing one item: a T-shirt, a dress, a coat, etc."),
            message("W", "Given a picture, our model predicts which item it is?\nLet's get started!"),
            ...
            message("W", "Let's define a function to compute it!"),
            {
                ...message("D", "The score is the dot-product between the pattern and the segment, which share the same shape."),
            ...
            message("W", "In our case, `n` is `3`, the length of the pattern? For the first segment in the signal, we have `dot(Tensor([0.0, 1.0, 0.0]), Tensor([0.0, 1.0, 0.0]))`, which is `1.0`."),
            {
                ...message("D", "Next we slide the pattern and compute `dot` on every segment. The function is called `corr1d` for correlation of rank-1 tensors.\n"),
                codeLabel: "`corr1d` definition",
                buildCodeBlock: (_ast) => corr1dDefinitionBlock,
                textAfterCode: "It's a long function. Let's start with its type."
            },
            message("W", "The pattern `p` and signal `s` are rank-1 tensors, but have different shapes. " +
                "The result is also rank-1, with `m - n + 1` elements, since there are `m - n + 1 ` segments.\n" +
                "Does `corr1d` return a tensor?"),
            message("D", "It does. `[... for ... in ...]` is a !!tensor comprehension!!.\n" +
            ...
            message("D", "Now we enhance the coverage of `corr1d`."),
            message("W", "The coverage on what?"),
            {
                ...message("D", "On the elements at the front and at the end.\n" +
            ...
            {
                ...message("W", "It returns additional `2 * padding` elements, comparing with the vanilla `corr1d`."),
            ...
            {
                ...message("D", "There is also a trick to make `corr1d` more flexible.\n" +
                ...
                buildCodeBlock: (_ast) => rangeDefinitionBlock,
            ...
            {
                ...message("W", "`corr1d_stride` should return `(m - n + stride) / stride` elements."),
                codeLabel: "`corr1d_stride` and `corr1d_padded_stride` definitions",
                buildCodeBlock: (_ast) => corr1dStridePairDefinitionBlock,
            }
        ],
    });
})();
