    ...
    render({
        ...
        section: {
            ...
            dialog: [
                ...
                message(
                    "W",
                    "Oh! The `List` `[2, 3]` corresponds to the shape of `[[1, 2, 3], [4, 5, 6]]`, since the outer layer has contains `List[int]`s and the inner layer contains three `int`s?",
                ),
                message("D", "Exactly!\nCan we make `[[1, 2, 3], [4, 5]]` a `Tensor`?"),
                message("W", "Hmm... I don't know how to describe its shape."),
                message(
                    "D",
                    "And you are not wrong. We cannot make `[[1, 2, 3], [4, 5]]` a `Tensor`, since no one can describe its shape!",
                ),
                message(
                    "W",
                ...
                message(
                    "W",
                    "Are `Tensor[int][[]]` and `int` the same type?"
                ),
                message(
                    "D",
