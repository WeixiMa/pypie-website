...
const lineDefinitionBlock = {
    ...
    render({
        ...
        dialog: [
            ...
            message(
                "W",
                "I see. With the upgraded type, `+` now applies to our case, where `T` becomes `float`. " +
                "Then, `w * x + b` has type `float`. The same with the `float` in `line`'s `def`."
            ),
            message(
                "D",
                "Right. `pypie` validates if the type of `y` matches the expected result. " +
                "Should there be a mismatch, `pypie` alerts us."
            ),
            {
                ...message(
                "W",
                "Let me try a wrong example to trigger the alert: turning the expected type to `int`."
                ),
            ...
            },
            {
                ...message(
                    "D",
                    "Here's a visualization of the four points on our line.*"
                ),
            ...
            ),
            {
                ...message(
                    "D",
                "Yes, we call this function **`loss`**."
                ),
            ...
            message(
                "W",
                "We just imported something new from `pypie`.\n" +
                "What is `Var(\"n\", int)`?"
            ),
            message(
                "D",
                "It creates a **`Var`**iable that represents an arbitrary `int`. " +
