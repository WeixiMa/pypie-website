(() => {
    ...
    render({
        ...
        dialog: [
            ...
            message("D", 
                "`2` is correct, but it wasn't easy.\n" + 
            ...
            message(
                "D",
                "How about `Tensor([[1, 2, 3], [3, 2, 1]]) + Tensor([5, 7, 9])`?"
            ),
            message(
                "W",
                "Can we add these two `Tensor`s? Their shapes are different:\n" +
                "one is `Tensor[int][[2, 3]]` and the other is `Tensor[int][[3]]`."
            ),
            message(
                "D",
                "Yes, as long as the smaller shape is a suffix of the larger shape.\n" + 
            ...
            message(
                "D",
                "This trick is called rank polymorphism. It applies to many `Tensor` `op`s."
            ),
            message(
                "W",
                "Are there other `op`s besides `+`?"
            ),
            message(
                "D",
                "Many. In fact, you can define as many `op`s as you need.\n" +
